...
|others|Re-identification, Retail Object Recognition, PoseClassificationNet, OCDNet, OCRNet, LPDNet, LPRNet, BodyPose3DNet|refer detailed [README](apps/tao_others/README.md) for how to configure and run the model|
...
- refer detailed [README](apps/tao_others/README.md) for how to configure and run the model
