...
#ifndef DEEPSTREAM_LIDAR_INFER_CONTEXT_APP_H
#define DEEPSTREAM_LIDAR_INFER_CONTEXT_APP_H
...
namespace ds3d { namespace lidarinfer {

class DsLidarInferAppContext {
public:
    DsLidarInferAppContext() {}
    virtual ~DsLidarInferAppContext() { deinit(); }
...
protected:
    ...
    {
        DsLidarInferAppContext* ctx = static_cast<DsLidarInferAppContext*>(data);
...
#endif  // DEEPSTREAM_LIDAR_INFER_CONTEXT_APP_H
