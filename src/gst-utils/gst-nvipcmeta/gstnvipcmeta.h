...
#define GST_NV_IPC_META_STRING "nvipcmeta"

#define GST_NV_IPC_META_GET(buf) ((GstNvIpcMeta *)gst_buffer_get_meta(buf,GST_NV_IPC_META_API_TYPE))
#define GST_NV_IPC_META_ADD(buf) ((GstNvIpcMeta *)gst_buffer_add_meta(buf,GST_NV_IPC_META_INFO,NULL))
