...
#ifndef __GSTNVINFERBASE_IMPL_H__
#define __GSTNVINFERBASE_IMPL_H__
...
typedef struct {
  ...
  NvDsAudioFrameMeta *audio_frame_meta = nullptr;
...
public:
  ...
  DsNvInferImpl (GstNvInferBase *infer);
  ~DsNvInferImpl ();
...
private:
  ...
  GstNvInferBase *m_GstInfer = nullptr;
