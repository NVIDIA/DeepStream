...
template<> ::nv::Conversation* Arena::CreateMaybeMessage<::nv::Conversation>(Arena*);
...
class LLM final :
 ...
 public:
  ...
  // repeated .nv.Conversation conversations = 2;
  int conversations_size() const;
  private:
  int _internal_conversations_size() const;
  public:
  void clear_conversations();
  ::nv::Conversation* mutable_conversations(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Conversation >*
      mutable_conversations();
  private:
  const ::nv::Conversation& _internal_conversations(int index) const;
  ::nv::Conversation* _internal_add_conversations();
  public:
  const ::nv::Conversation& conversations(int index) const;
  ::nv::Conversation* add_conversations();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Conversation >&
      conversations() const;

  // repeated .nv.Embedding embeddings = 3;
  int embeddings_size() const;
  private:
  int _internal_embeddings_size() const;
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::MapField<
        ...
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> info_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Conversation > conversations_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Embedding > embeddings_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class Conversation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:nv.Conversation) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:nv.Conversation)
 private:
  class _Internal;
...
// repeated .nv.Conversation conversations = 2;
inline int LLM::_internal_conversations_size() const {
  return _impl_.conversations_.size();
}
inline int LLM::conversations_size() const {
  return _internal_conversations_size();
}
inline void LLM::clear_conversations() {
  _impl_.conversations_.Clear();
}
inline ::nv::Conversation* LLM::mutable_conversations(int index) {
  // @@protoc_insertion_point(field_mutable:nv.LLM.conversations)
  return _impl_.conversations_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Conversation >*
LLM::mutable_conversations() {
  // @@protoc_insertion_point(field_mutable_list:nv.LLM.conversations)
  return &_impl_.conversations_;
}
inline const ::nv::Conversation& LLM::_internal_conversations(int index) const {
  return _impl_.conversations_.Get(index);
}
inline const ::nv::Conversation& LLM::conversations(int index) const {
  // @@protoc_insertion_point(field_get:nv.LLM.conversations)
  return _internal_conversations(index);
}
inline ::nv::Conversation* LLM::_internal_add_conversations() {
  return _impl_.conversations_.Add();
}
inline ::nv::Conversation* LLM::add_conversations() {
  ::nv::Conversation* _add = _internal_add_conversations();
  // @@protoc_insertion_point(field_add:nv.LLM.conversations)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Conversation >&
LLM::conversations() const {
  // @@protoc_insertion_point(field_list:nv.LLM.conversations)
  return _impl_.conversations_;
}

// repeated .nv.Embedding embeddings = 3;
inline int LLM::_internal_embeddings_size() const {
  return _impl_.embeddings_.size();
}
inline int LLM::embeddings_size() const {
  return _internal_embeddings_size();
}
inline void LLM::clear_embeddings() {
  _impl_.embeddings_.Clear();
}
inline ::nv::Embedding* LLM::mutable_embeddings(int index) {
  // @@protoc_insertion_point(field_mutable:nv.LLM.embeddings)
  return _impl_.embeddings_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Embedding >*
LLM::mutable_embeddings() {
  // @@protoc_insertion_point(field_mutable_list:nv.LLM.embeddings)
  return &_impl_.embeddings_;
}
inline const ::nv::Embedding& LLM::_internal_embeddings(int index) const {
  return _impl_.embeddings_.Get(index);
}
inline const ::nv::Embedding& LLM::embeddings(int index) const {
  // @@protoc_insertion_point(field_get:nv.LLM.embeddings)
  return _internal_embeddings(index);
}
inline ::nv::Embedding* LLM::_internal_add_embeddings() {
  return _impl_.embeddings_.Add();
}
inline ::nv::Embedding* LLM::add_embeddings() {
  ::nv::Embedding* _add = _internal_add_embeddings();
  // @@protoc_insertion_point(field_add:nv.LLM.embeddings)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::nv::Embedding >&
LLM::embeddings() const {
  // @@protoc_insertion_point(field_list:nv.LLM.embeddings)
  return _impl_.embeddings_;
}
...
inline const std::string& Conversation::id() const {
  // @@protoc_insertion_point(field_get:nv.Conversation.id)
  return _internal_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Conversation::set_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:nv.Conversation.id)
}
inline std::string* Conversation::mutable_id() {
  std::string* _s = _internal_mutable_id();
  // @@protoc_insertion_point(field_mutable:nv.Conversation.id)
  return _s;
}
inline const std::string& Conversation::_internal_id() const {
  return _impl_.id_.Get();
}
inline void Conversation::_internal_set_id(const std::string& value) {
  
  _impl_.id_.Set(value, GetArenaForAllocation());
}
inline std::string* Conversation::_internal_mutable_id() {
  
  return _impl_.id_.Mutable(GetArenaForAllocation());
}
inline std::string* Conversation::release_id() {
  // @@protoc_insertion_point(field_release:nv.Conversation.id)
  return _impl_.id_.Release();
}
inline void Conversation::set_allocated_id(std::string* id) {
  if (id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:nv.Conversation.id)
}

// string query = 2;
inline void Conversation::clear_query() {
  _impl_.query_.ClearToEmpty();
}
inline const std::string& Conversation::query() const {
  // @@protoc_insertion_point(field_get:nv.Conversation.query)
  return _internal_query();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Conversation::set_query(ArgT0&& arg0, ArgT... args) {
 
 _impl_.query_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:nv.Conversation.query)
}
inline std::string* Conversation::mutable_query() {
  std::string* _s = _internal_mutable_query();
  // @@protoc_insertion_point(field_mutable:nv.Conversation.query)
  return _s;
}
inline const std::string& Conversation::_internal_query() const {
  return _impl_.query_.Get();
}
inline void Conversation::_internal_set_query(const std::string& value) {
  
  _impl_.query_.Set(value, GetArenaForAllocation());
}
inline std::string* Conversation::_internal_mutable_query() {
  
  return _impl_.query_.Mutable(GetArenaForAllocation());
}
inline std::string* Conversation::release_query() {
  // @@protoc_insertion_point(field_release:nv.Conversation.query)
  return _impl_.query_.Release();
}
inline void Conversation::set_allocated_query(std::string* query) {
  if (query != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:nv.Conversation.query)
}

// string response = 3;
inline void Conversation::clear_response() {
  _impl_.response_.ClearToEmpty();
}
inline const std::string& Conversation::response() const {
  // @@protoc_insertion_point(field_get:nv.Conversation.response)
  return _internal_response();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Conversation::set_response(ArgT0&& arg0, ArgT... args) {
 
 _impl_.response_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:nv.Conversation.response)
}
inline std::string* Conversation::mutable_response() {
  std::string* _s = _internal_mutable_response();
  // @@protoc_insertion_point(field_mutable:nv.Conversation.response)
  return _s;
}
inline const std::string& Conversation::_internal_response() const {
  return _impl_.response_.Get();
}
inline void Conversation::_internal_set_response(const std::string& value) {
  
  _impl_.response_.Set(value, GetArenaForAllocation());
}
inline std::string* Conversation::_internal_mutable_response() {
  
  return _impl_.response_.Mutable(GetArenaForAllocation());
}
inline std::string* Conversation::release_response() {
  // @@protoc_insertion_point(field_release:nv.Conversation.response)
  return _impl_.response_.Release();
}
inline void Conversation::set_allocated_response(std::string* response) {
  if (response != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:nv.Conversation.response)
}
