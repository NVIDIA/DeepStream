...
bool
nvds_msg2p_parse_csv(void* privData, const gchar* file)
{
    NvDsPayloadPriv* privObj = NULL;
    NvDsAnalyticsObject analyticsObj;
...
bool
nvds_msg2p_parse_yaml(void* privData, const gchar* file)
{
    bool retVal = true;
...
bool
nvds_msg2p_parse_key_value(void* privData, const gchar* file)
{
    bool retVal = true;
...
void
destroy_deepstream_schema_ctx(void* ptr)
{
