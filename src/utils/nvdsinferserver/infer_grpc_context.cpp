...
NvDsInferStatus
InferGrpcContext::getConfigInOutMap(
...
NvDsInferStatus
InferGrpcContext::specifyBackendDims(
...
NvDsInferStatus
InferGrpcContext::createNNBackend(
...
NvDsInferStatus
InferGrpcContext::allocateResource(const ic::InferenceConfig& config)
{
