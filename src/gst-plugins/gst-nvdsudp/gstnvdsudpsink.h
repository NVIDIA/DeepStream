...
struct _GstNvDsUdpSink
{
  ...
  guint64 rtp_timestamp_offset;  /* RTP timestamp offset in nanoseconds */
  ...
  rmx_mem_region **chunks;  /* Array of pointers to packet arrays (new API) */
  ...
  size_t payload_mem_block_id;  /* Memory block ID for payload */
  size_t header_mem_block_id;   /* Memory block ID for header */
  rmx_output_gen_chunk_handle chunk_handle;  /* Chunk handle for generic API */
  rmx_output_media_chunk_handle media_chunk_handle;  /* Chunk handle for media API */
