...
## To Cite the Project 
If you use the Project in a publication, please use citations in the following format (BibTeX entry for LaTeX):
```tex
@Manual{,
  title = {Project_Name: Collection of Libraries for End to End GPU Data Science},
  author = {Project_Name Development Team},
  year = {2018},
  url = {Project_url},
}
```
