...
1. **Create parameter schema**: `backends/parameters/onnxruntime-parameters.schema.json`
   ```json
   {
     ...
     "$id": "https://raw.githubusercontent.com/NVIDIA-AI-IOT/deepstream/main/tools/inference_builder/schemas/backends/parameters/onnxruntime-parameters.schema.json",
...
2. **Create backend schema**: `backends/onnxruntime.schema.json`
   ...
   {
     "$schema": "http://json-schema.org/draft-07/schema#",
     "$id": "https://raw.githubusercontent.com/NVIDIA-AI-IOT/deepstream/main/tools/inference_builder/schemas/backends/onnxruntime.schema.json",
...
```json
"$id": "https://raw.githubusercontent.com/NVIDIA-AI-IOT/deepstream/main/tools/inference_builder/schemas/config.schema.json"
```
