...
class ProfilesDictionary final :
 ...
 public:
  ...
  void MergeFrom( const ProfilesDictionary& from) {
    ProfilesDictionary::MergeImpl(*this, from);
  }
  private:
...
inline ::opentelemetry::proto::common::v1::KeyValue* ProfilesDictionary::mutable_attribute_table(int index) {
...
inline const ::opentelemetry::proto::common::v1::KeyValue& ProfilesDictionary::_internal_attribute_table(int index) const {
  return _impl_.attribute_table_.Get(index);
}
inline const ::opentelemetry::proto::common::v1::KeyValue& ProfilesDictionary::attribute_table(int index) const {
...
inline ::opentelemetry::proto::common::v1::KeyValue* ProfilesDictionary::_internal_add_attribute_table() {
  return _impl_.attribute_table_.Add();
}
inline ::opentelemetry::proto::common::v1::KeyValue* ProfilesDictionary::add_attribute_table() {
...
// repeated .opentelemetry.proto.profiles.v1development.AttributeUnit attribute_units = 7;
inline int ProfilesDictionary::_internal_attribute_units_size() const {
  return _impl_.attribute_units_.size();
}
inline int ProfilesDictionary::attribute_units_size() const {
  return _internal_attribute_units_size();
}
inline void ProfilesDictionary::clear_attribute_units() {
  _impl_.attribute_units_.Clear();
}
inline ::opentelemetry::proto::profiles::v1development::AttributeUnit* ProfilesDictionary::mutable_attribute_units(int index) {
  // @@protoc_insertion_point(field_mutable:opentelemetry.proto.profiles.v1development.ProfilesDictionary.attribute_units)
...
ProfilesDictionary::mutable_attribute_units() {
  // @@protoc_insertion_point(field_mutable_list:opentelemetry.proto.profiles.v1development.ProfilesDictionary.attribute_units)
  return &_impl_.attribute_units_;
}
inline const ::opentelemetry::proto::profiles::v1development::AttributeUnit& ProfilesDictionary::_internal_attribute_units(int index) const {
  return _impl_.attribute_units_.Get(index);
}
inline const ::opentelemetry::proto::profiles::v1development::AttributeUnit& ProfilesDictionary::attribute_units(int index) const {
  // @@protoc_insertion_point(field_get:opentelemetry.proto.profiles.v1development.ProfilesDictionary.attribute_units)
  return _internal_attribute_units(index);
}
inline ::opentelemetry::proto::profiles::v1development::AttributeUnit* ProfilesDictionary::_internal_add_attribute_units() {
  return _impl_.attribute_units_.Add();
}
inline ::opentelemetry::proto::profiles::v1development::AttributeUnit* ProfilesDictionary::add_attribute_units() {
  ::opentelemetry::proto::profiles::v1development::AttributeUnit* _add = _internal_add_attribute_units();
  // @@protoc_insertion_point(field_add:opentelemetry.proto.profiles.v1development.ProfilesDictionary.attribute_units)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::opentelemetry::proto::profiles::v1development::AttributeUnit >&
ProfilesDictionary::attribute_units() const {
  // @@protoc_insertion_point(field_list:opentelemetry.proto.profiles.v1development.ProfilesDictionary.attribute_units)
  return _impl_.attribute_units_;
}
...
inline bool ProfilesData::_internal_has_dictionary() const {
  return this != internal_default_instance() && _impl_.dictionary_ != nullptr;
}
