...
from common.perf_utils import maximize_clocks, reset_clocks  # noqa: E402
...
def benchmark_script(
    ...
    nsys_root_path = "/opt/nvidia/nsight-systems/2024.6.1/"
    ...
    if not os.path.isfile(nsys_binary_path):
        raise ValueError(
            "Unable to locate nsys binary at %s. Make sure you have nsight-systems 2024.6.1 installed."
            % nsys_binary_path
        )
